...
export const Menu: React.FC = () => {
  ...
  return (
    <div
      role="menu"
      className="lv-menu lv-menu-light lv-menu-vertical menu-_pM9FX top-menu-OzXbX5"
    >
            ...
            {group.items.map((item) => (
              <div
                ...
                className={`lv-menu-item ${
                  selectedItemId === item.id ? "lv-menu-selected" : ""
      ...
      <style jsx>{`
        ...
        .lv-menu {
          ...
          padding: 8px;
          position: relative;
          transition: width 0.15s cubic-bezier(0.34, 0.69, 0.1, 1);
          width: 100%;
        }
        ...
        .menuGroup-jfQPdZ {
          border-bottom: 1px solid rgba(7, 50, 71, 0.06);
          display: flex;
          flex-direction: column;
        ...
        .mweb-menu-group-main,
        .mweb-menu-group-tools,
        .mweb-menu-group-other {
          padding: 0;
          --side-menu-gap: 4px;
        }

        .menu-_pM9FX .lv-menu-item.lv-menu-selected {
          background: var(--Fill-Transparency-Hover, rgba(69, 108, 128, 0.12));
        ...
        .menu-_pM9FX .lv-menu-item.lv-menu-item-size-default {
          ...
          border-radius: 8px;
          box-sizing: border-box;
          color: var(--lvv-color-text-secondary, rgba(17, 26, 44, 0.7));
          font-size: 14px;
          font-style: normal;
          font-weight: 500;
          line-height: 16px;
        ...
        .lv-menu-inner .lv-menu-item.lv-menu-item-size-default:hover,
        .lv-menu-inner .lv-menu-item.lv-menu-selected {
